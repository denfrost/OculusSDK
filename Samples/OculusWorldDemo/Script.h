...
//    SetPose           <x pos> <y pos> <z pos> <x ori> <y ori> <z ori> Sets the HMD pose meters and degrees.
...
//    Exit                                                              Exits the process with status code
...
protected:
    ...
    struct CommandSetPose : public Command {
        CommandSetPose() : Command{CommandType::SetPose}, X(), Y(), Z(), OriX{}, OriY{}, OriZ{}{}
